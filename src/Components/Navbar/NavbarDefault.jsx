...
export function NavbarDefault() {
  ...
  const navList = (
    <ul className="mt-4 mb-4 flex flex-col gap-2 items-center ">
      <Typography
        as="li"
        variant="small"
        color="blue-gray"
  ...
  return (
    <Navbar className="mx-auto max-w-screen-sm px-4 py-2 ">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        ...
        <div className="flex items-center gap-x-1">
          <Button variant="text" size="sm" className="inline-block">
            <span>Log In</span>
          </Button>
          <Button
            variant="gradient"
